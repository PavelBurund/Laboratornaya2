...
public:
	...
	std::vector<double> virtual getParameters() = 0;
...
public:
	...
	{ 
		return std::vector<double> { side1, side2, side3 };
	}
...
public:
	...
	std::vector<double> getParameters()
	{
		return std::vector<double> { width, height };
	}
	std::string virtual info() override
	{
...
public:
	...
	std::vector<double> getParameters()
	{
		return std::vector<double> { radius };
	}
	std::string virtual info() override
	{
